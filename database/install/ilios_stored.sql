...
-- This does the same exact same thing as courses_with_title_restricted_by_school_for_user, except that it does not
-- filter out archived courses, as they should remain in the calendar as a permanent record for the user
