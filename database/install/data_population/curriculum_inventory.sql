...
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0104','Interpret laboratory data, imaging studies, and other tests required for the area of practice');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0105','Counsel and educate patients and their families to empower them to participate in their care, showing consideration for their perspective throughout treatment');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0106','Make informed decisions about diagnostic and therapeutic interventions based on patient information and preferences, up-to-date scientific evidence, and clinical judgment');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0107','Develop and carry out patient management plans');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0108','Provide appropriate referral of patients including ensuring continuity of care throughout transitions between providers or settings, and following up on patient progress and outcomes');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0109','Provide health care services to patients, families, and communities aimed at preventing health problems');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0201','Demonstrate an investigatory and analytic approach to clinical situations');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0202','Apply established and emerging bio-physical scientific principles fundamental to health care for patients and populations');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0203','Apply established and emerging principles of clinical sciences to diagnostic and therapeutic decision-making, clinical problem-solving, and other aspects of evidence-based health care');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0204','Apply principles of epidemiological sciences to the identification of health problems, risk factors, treatment strategies, resources, and disease prevention/health promotion efforts for patients and populations');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0205','Apply principles of social-behavioral sciences to provision of patient care, including assessment of the impact of psychosocial-cultural influences on health, disease, care-seeking, care-compliance, barriers to and attitudes toward care');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0206','Contribute to the creation, dissemination, application, and translation of new health care knowledge and practices');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0301','Identify strengths, deficiencies, and limits in one’s knowledge and expertise');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0302','Set learning and improvement goals');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0303','Identify and perform learning activities that address one’s gaps in knowledge, skills or attitudes');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0304','Systematically analyze practice using quality improvement methods, and implement changes with the goal of practice improvement');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0305','Incorporate feedback into daily practice');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0306','Locate, appraise, and assimilate evidence from scientific studies related to patients’ health problems');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0307','Use information technology to optimize learning');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0308','Participate in the education of patients, families, students, trainees, peers and other health professionals');
...
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0405','Maintain comprehensive, timely, and legible medical records');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0406','Demonstrate sensitivity, honesty, and compassion in difficult conversations about issues such as death, end-of-life issues, adverse events, bad news, disclosure of errors, and other sensitive topics');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0501','Demonstrate compassion, integrity, and respect for others');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0502','Demonstrate responsiveness to patient needs that supersedes self-interest');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0503','Demonstrate respect for patient privacy and autonomy');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0504','Demonstrate accountability to patients, society and the profession');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0505','Demonstrate sensitivity and responsiveness to a diverse patient population, including but not limited to diversity in gender, age, culture, race, religion, disabilities, and sexual orientation');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0506','Demonstrate a commitment to ethical principles pertaining to provision or withholding of care, confidentiality, informed consent, and business practices, including compliance with relevant laws, policies, and regulations');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0601','Work effectively in various health care delivery settings and systems relevant to their clinical specialty');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0602','Coordinate patient care within the health care system relevant to their clinical specialty');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0603','Incorporate considerations of cost awareness and risk-benefit analysis in patient and/or population-based care');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0604','Advocate for quality patient care and optimal patient care systems');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0605','Work in interprofessional teams to enhance patient safety and improve patient care quality');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0606','Participate in identifying system errors and implementing potential systems solutions');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0701','Work in cooperation with other professionals to establish and maintain a climate of respect, dignity, diversity, ethical integrity, and trust in order to enhance team functioning and serve the needs of patients, families, and populations');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0702','Utilize and enhance one’s own expertise by understanding and engaging the unique and diverse knowledge, skills, and abilities of other professionals to enhance team performance and maximize the quality of patient care');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0703','Exchange relevant information effectively with patients, families, communities, and other health professionals in a respectful, responsive, and responsible manner, considering varied perspectives and ensuring common understanding of, agreement with, and adherence to care decisions for optimal outcomes');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0704','Participate in and engage other members of interprofessional patient care teams in the establishment, development, leadership, and continuous enhancement of the team in order to provide care that is safe, timely, efficient, effective, and equitable');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0801','Develop the ability to use self-awareness of knowledge, skills and emotional limitations to engage in appropriate help-seeking behaviors');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0802','Demonstrate healthy coping mechanisms to respond to stress');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0803','Manage conflict between personal and professional responsibilities');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0804','Practice flexibility and maturity in adjusting to change with the capacity to alter behavior');
INSERT INTO `aamc_mecrs` (`mecrs_id`, `description`) VALUES ('aamc-mecrs-comp-c0805','Demonstrate trustworthiness that makes colleagues feel secure when one is responsible for the care of patients');
