...
#[OA\Tag(name:'Pending user updates')]
#[Route('/api/{version<v3>}/pendinguserupdates')]
class PendingUserUpdates extends AbstractApiController
{
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'A single pending user update.',
    ...
    #[OA\Get(
        path: "/api/{version}/pendinguserupdates",
        summary: "Fetch all pending user updates.",
        parameters: [
            new OA\Parameter(name: 'version', description: 'API Version', in: 'path'),
            new OA\Parameter(
                name: 'offset',
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'An array of pending user updates.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'pendingUserUpdates',
    ...
    #[OA\Post(
        path: '/api/{version}/pendinguserupdates',
        summary: "Create pending user updates.",
        ...
        responses: [
            new OA\Response(
                response: '201',
                description: 'An array of newly created pending user updates.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'pendingUserUpdates',
