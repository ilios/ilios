...
class Programs extends AbstractApiController
{
    ...
    #[OA\Put(
        path: '/api/{version}/programs/{id}',
        summary: 'Update or create a program.',
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
                properties: [
        ...
        responses: [
            ...
            new OA\Response(
                response: '201',
                description: 'The newly created program.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'program',
