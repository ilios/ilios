...
class ProgramYear extends ReadWriteController
{
    ...
    public function __construct(ProgramYearManager $manager, CohortManager $cohortManager)
    {
     ...
     */
    public function postProgramYear(
        string $version,
        Request $request,
        ...
        $entities = $serializer->deserialize(json_encode($cleanData), $class, 'json');
     ...
     */
    public function putProgramYear(
        string $version,
        string $id,
        Request $request,
        ApiRequestParser $requestParser,
