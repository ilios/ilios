...
#[OA\Tag(name:'Session types')]
#[Route('/api/{version<v3>}/sessiontypes')]
class SessionTypes extends AbstractApiController
{
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'A single session type.',
    ...
    #[OA\Get(
        path: "/api/{version}/sessiontypes",
        summary: "Fetch all session types.",
        parameters: [
            new OA\Parameter(name: 'version', description: 'API Version', in: 'path'),
            new OA\Parameter(
                name: 'offset',
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'An array of session types.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'sessionTypes',
    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(
                response: '201',
                description: 'An array of newly created session types.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'sessionTypes',
