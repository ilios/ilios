...
class Schools extends ReadWriteController
{
    ...
    /**
     * @Route("/api/{version<v3>}/schools/{id}", methods={"PUT"})
     * @inheritdoc
     */
    public function put(
        string $version,
    ...
    /**
     * @Route("/api/{version<v3>}/schools", methods={"POST"})
     * @inheritdoc
     */
    ...
    /**
     * @Route("/api/{version<v3>}/schools/{id}", methods={"PATCH"})
     * @inheritdoc
     */
    ...
    /**
     * @Route("/api/{version<v3>}/schools/{id}", methods={"DELETE"})
     * @inheritdoc
     */
