...
#[OA\Tag(name:'Course clerkship types')]
...
class CourseClerkshipTypes extends AbstractApiController
{
    ...
    public function __construct(
        CourseClerkshipTypeRepository $repository,
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'A single course clerkship type.',
    ...
    #[OA\Get(
        path: "/api/{version}/courseclerkshiptypes",
        summary: "Fetch all course clerkship types.",
        parameters: [
            new OA\Parameter(name: 'version', description: 'API Version', in: 'path'),
            new OA\Parameter(
                name: 'offset',
        ...
        responses: [
            new OA\Response(
                response: '200',
                description: 'An array of course clerkship types.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'courseClerkshipTypes',
    ...
    #[OA\Post(
        path: '/api/{version}/courseclerkshiptypes',
        summary: "Create course clerkship types.",
        ...
        responses: [
            new OA\Response(
                response: '201',
                description: 'An array of newly created course clerkship types.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(
                            'courseClerkshipTypes',
