 ...
 */
class CurriculumInventoryAcademicLevelRepository extends EntityRepository
{
    /**
     * @inheritdoc
     */
    ...
    public function findDTOsBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
    {
        ...
        /** @var CurriculumInventoryAcademicLevelDTO[] $curriculumInventoryAcademicLevelDTOs */
        $curriculumInventoryAcademicLevelDTOs = [];
        foreach ($qb->getQuery()->getResult(AbstractQuery::HYDRATE_ARRAY) as $arr) {
            $curriculumInventoryAcademicLevelDTOs[$arr['id']] = new CurriculumInventoryAcademicLevelDTO(
                $arr['id'],
                $arr['name'],
                $arr['description'],
                $arr['level']
        ...
        $curriculumInventoryAcademicLevelIds = array_keys($curriculumInventoryAcademicLevelDTOs);
        ...
        foreach ($qb->getQuery()->getResult() as $arr) {
            $curriculumInventoryAcademicLevelDTOs[$arr['xId']]->report = (int) $arr['reportId'];
            $curriculumInventoryAcademicLevelDTOs[$arr['xId']]->school = $arr['schoolId']?(int)$arr['schoolId']:null;
        }
        ...
        foreach ($related as $rel) {
            $qb = $this->_em->createQueryBuilder()
                ...
                ->setParameter('ids', $curriculumInventoryAcademicLevelIds);
            foreach ($qb->getQuery()->getResult() as $arr) {
                $curriculumInventoryAcademicLevelDTOs[$arr['curriculumInventoryAcademicLevelId']]->{$rel}[] = $arr['relId'];
            }
        }
        return array_values($curriculumInventoryAcademicLevelDTOs);
    }
