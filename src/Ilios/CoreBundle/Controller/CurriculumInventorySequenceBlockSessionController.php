...
class CurriculumInventorySequenceBlockSessionController extends FOSRestController
{
    ...
    {
        try {
            $handler = $this->getCurriculumInventorySequenceBlockSessionHandler();
            ...
            $this->getCurriculumInventorySequenceBlockSessionHandler()->updateCurriculumInventorySequenceBlockSession($curriculumInventorySequenceBlockSession, true, false);
    ...
    public function putAction(Request $request, $id)
    {
        try {
            ...
            if ($curriculumInventorySequenceBlockSession) {
                ...
                $curriculumInventorySequenceBlockSession = $this->getCurriculumInventorySequenceBlockSessionHandler()
                    ->createCurriculumInventorySequenceBlockSession();
            ...
            $this->getCurriculumInventorySequenceBlockSessionHandler()->updateCurriculumInventorySequenceBlockSession($curriculumInventorySequenceBlockSession, true, true);
