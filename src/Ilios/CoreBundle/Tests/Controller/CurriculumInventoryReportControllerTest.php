...
class CurriculumInventoryReportControllerTest extends AbstractControllerTest
{
    ...
    {
        $curriculumInventoryReport = $this->container->get('ilioscore.dataloader.curriculuminventoryreport')->getOne()['curriculumInventoryReport'];
        $this->createJsonRequest('GET', $this->getUrl('get_curriculuminventoryreports', ['id' => $curriculumInventoryReport['id']]));
    ...
    public function testPostCurriculumInventoryReport()
    {
        $this->createJsonRequest(
            ...
            json_encode($this->container->get('ilioscore.dataloader.curriculuminventoryreport')->create()['curriculumInventoryReport'])
        );
    ...
    {
        $invalidCurriculumInventoryReport = array_shift($this->container->get('ilioscore.dataloader.curriculuminventoryreport')->invalid());
        $this->createJsonRequest('POST', $this->getUrl('post_curriculuminventoryreports'), $invalidCurriculumInventoryReport);
        $response = $this->client->getResponse();
    ...
    {
        $curriculumInventoryReport = $this->container->get('ilioscore.dataloader.curriculuminventoryreport')->createWithId()['curriculumInventoryReport'];

        $this->createJsonRequest(
            'PUT',
            $this->getUrl('put_curriculuminventoryreports', ['id' => $curriculumInventoryReport['id']]),
        ...
        $this->assertEquals(
            $this->container->get('ilioscore.dataloader.curriculuminventoryreport')->getLastCreated()['curriculumInventoryReport'],
            json_decode($response->getContent(), true)['curriculumInventoryReport']
        );
    }
    ...
    public function testDeleteCurriculumInventoryReport()
    {
        ...
        $response = $this->client->getResponse();
        $this->assertJsonResponse($response, Codes::HTTP_CREATED);
        $this->client->request('DELETE', $this->getUrl('delete_curriculuminventoryreports', ['id' => $curriculumInventoryReport['id']]));
        $response = $this->client->getResponse();
        $this->assertEquals(Codes::HTTP_NO_CONTENT, $response->getStatusCode());
        $this->client->request('GET', $this->getUrl('get_curriculuminventoryreports', ['id' => $curriculumInventoryReport['id']]));
        $response = $this->client->getResponse();
    ...
    {
        $this->createJsonRequest('GET', $this->getUrl('get_curriculuminventoryreports', ['id' => '-9999']));
        $response = $this->client->getResponse();
