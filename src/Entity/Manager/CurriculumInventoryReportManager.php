...
class CurriculumInventoryReportManager extends BaseManager
{
    ...
    public function getEvents(CurriculumInventoryReportInterface $report)
    {
        ...
        $sessionIds = $repo->getCountForOneOfferingSessionIds($report);
        $excludedSessionids = $repo->getExcludedSessionIds($report);
    ...
    public function getEventReferencesForSequenceBlocks(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getEventReferencesForSequenceBlocks($report, $eventIds);
    ...
    public function getCompetencyObjectReferencesForSequenceBlocks(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getCompetencyObjectReferencesForSequenceBlocks($report);
    ...
    public function getCompetencyObjectReferencesForEvents(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getCompetencyObjectReferencesForEvents(
            $report,
            $eventIds
        );
    ...
    public function getSessionObjectivesToCourseObjectivesRelations(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getSessionObjectivesToCourseObjectivesRelations(
            $sessionObjectiveIds,
            $courseObjectiveIds
        );
    ...
    public function getCourseObjectivesToProgramObjectivesRelations(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getCourseObjectivesToProgramObjectivesRelations(
            $courseObjectiveIds,
            $programObjectiveIds
        );
    ...
    public function getProgramObjectivesToPcrsRelations(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getProgramObjectivesToPcrsRelations(
            $programObjectiveIds,
            $pcrsIds
        );
    ...
    public function getEventsFromOfferingsOnlySessions(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getEventsFromOfferingsOnlySessions($report, $excludedSessionIds);
    ...
    public function getEventsFromIlmOnlySessions(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getEventsFromIlmOnlySessions($report, $excludedSessionIds);
    ...
    public function getEventsFromIlmSessionsWithOfferings(
        ...
        /** @var CurriculumInventoryReportRepository $repo */
        $repo = $this->getRepository();
        $rows = $repo->getEventsFromIlmSessionsWithOfferings($report, $excludedSessionIds);
