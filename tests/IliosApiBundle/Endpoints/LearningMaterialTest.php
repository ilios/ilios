...
class LearningMaterialTest extends AbstractEndpointTest
{
    ...
    public function filtersToTest()
    {
        return [
            ...
            'revised' => [[2, 3], ['status' => LearningMaterialStatusInterface::REVISED]],
            'owningUser' => [[0, 1, 2, 3], ['owningUser' => 1]],
            ...
            'copyrightPermission' => [[0, 2, 3], ['copyrightPermission' => true]],
            'noCopyrightPermission' => [[1], ['copyrightPermission' => false]],
            'copyrightRationale' => [[2, 3], ['copyrightRationale' => 'i own it']],
            'filename' => [[2], ['filename' => 'testfile.txt']],
            'mimetype' => [[2], ['mimetype' => 'text/plain']],
            'filesize' => [[2, 3], ['filesize' => 1000]],
            'link' => [[1], ['link' => 'http://example.com/example-file.txt']],
            'courses' => [[0, 1, 2], ['courses' => [1]]],
            'sessions' => [[0], ['sessions' => [1]]],
            'instructors' => [[0, 2], ['instructors' => [1, 2]]],
            'instructorGroups' => [[0], ['instructorGroups' => [1]]],
            'terms' => [[0, 2], ['terms' => [3]]],
            'meshDescriptors' => [[0, 1, 2], ['meshDescriptors' => ['abc1', 'abc2']]],
