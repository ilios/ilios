...
class LearnerGroupTest extends AbstractBase
{
    ...
    {
        $this->checkRootAccess(LearnerGroup::class, LearnerGroupDTO::class);
    }
    ...
    public function testCanViewDTO()
    {
        ...
        $dto->id = 1;
        $dto->school = 1;
        $this->permissionChecker->shouldReceive('canReadLearnerGroup')->andReturn(true);
    ...
    public function testCanNotViewDTO()
    {
        ...
        $dto->id = 1;
        $dto->school = 1;
        $this->permissionChecker->shouldReceive('canReadLearnerGroup')->andReturn(false);
        $response = $this->voter->vote($token, $dto, [AbstractVoter::VIEW]);
