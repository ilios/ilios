...
class CurriculumInventorySequenceBlockTest extends AbstractBase
{
    ...
    {
        $this->checkRootAccess(CurriculumInventorySequenceBlock::class, CurriculumInventorySequenceBlockDTO::class);
    }

    public function testCanViewDTO()
    {
        $token = $this->createMockTokenWithNonRootSessionUser();
        $dto = m::mock(CurriculumInventorySequenceBlockDTO::class);
        $dto->id = 1;
        $dto->report = 1;
        $dto->school = 1;
