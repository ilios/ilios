...
use App\RelationshipVoter\AssessmentOption as Voter;
...
final class AssessmentOptionTest extends AbstractBase
{
    ...
    {
        $this->checkRootEntityAccess(m::mock(AssessmentOptionInterface::class));
    }
    ...
    public function testCanView(): void
    {
        ...
        $entity = m::mock(AssessmentOptionInterface::class);
