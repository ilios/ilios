...
use App\RelationshipVoter\AamcResourceType as Voter;
use App\Service\SessionUserPermissionChecker;
use App\Tests\RelationshipVoter\AbstractBase;
use Mockery as m;
...
final class AamcResourceTypeTest extends AbstractBase
{
    ...
    {
        $this->checkRootEntityAccess(m::mock(AamcResourceTypeInterface::class));
    }
    ...
    public function testCanView(): void
    {
        ...
        $entity = m::mock(AamcResourceTypeInterface::class);
