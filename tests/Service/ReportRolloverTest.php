...
class ReportRolloverTest extends TestCase
{
    ...
    public function reportProvider()
    {
        ...
        $topLevelBlock2->setChildSequenceOrder(CurriculumInventorySequenceBlockInterface::ORDERED);
        $topLevelBlock2->setDuration(0);
        $topLevelBlock2->setOrderInSequence(0);
        $topLevelBlock2->setMinimum(1);
        $topLevelBlock2->setMaximum(2);
        ...
        $subLevelBlock1->setChildSequenceOrder(CurriculumInventorySequenceBlockInterface::ORDERED);
        $subLevelBlock1->setDuration(0);
        $subLevelBlock1->setOrderInSequence(0);
        $subLevelBlock1->setMinimum(2);
        $subLevelBlock1->setMaximum(20);
        ...
        $subLevelBlock2->setChildSequenceOrder(CurriculumInventorySequenceBlockInterface::ORDERED);
        $subLevelBlock2->setDuration(10);
        $subLevelBlock2->setOrderInSequence(50);
        $subLevelBlock2->setMinimum(5);
        $subLevelBlock2->setMaximum(50);
        ...
        $subSubLevelBlock1->setChildSequenceOrder(CurriculumInventorySequenceBlockInterface::ORDERED);
        $subSubLevelBlock1->setDuration(3);
        $subSubLevelBlock1->setOrderInSequence(3);
        $subSubLevelBlock1->setMinimum(4);
        $subSubLevelBlock1->setMaximum(40);
