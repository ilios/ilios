...
class Migration_Link_aamc_methods_to_session_types extends CI_Migration
{
    ...
    public function up ()
    {
        ...
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM010', `session_type_id` FROM `session_type` WHERE title = 'Holiday' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM013', `session_type_id` FROM `session_type` WHERE title = 'Ceremony' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM010', `session_type_id` FROM `session_type` WHERE title = 'Deadline' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM013', `session_type_id` FROM `session_type` WHERE title = 'Learner Project Presentation' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM013', `session_type_id` FROM `session_type` WHERE title = 'Movie' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM007', `session_type_id` FROM `session_type` WHERE title = 'Panel Presentation' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM013', `session_type_id` FROM `session_type` WHERE title = 'Performance' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
        $sql = "INSERT INTO `session_type_x_aamc_method` (`method_id`, `session_type_id`) (SELECT 'IM007', `session_type_id` FROM `session_type` WHERE title = 'Social Event' AND `owning_school_id`  = 1)";
        $this->db->query($sql);
