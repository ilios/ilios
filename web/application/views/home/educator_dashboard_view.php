...
?>
                                    <li>
                                        <a href="<?php echo $curriculumInventoryManagerUrl; ?>">
                                            <?php echo $this->languagemap->t('curriculum_inventory.title_bar'); ?>
                                        </a>
                                    </li>
<?php
    endif;
            ...
            <div class="dialog_wrap" id="ap_dialog_wrap" style="height: 216px;">
                <form action="#">
                    <div style="padding: 9px; font-weight: bold; position: relative;">
                        <?php echo $this->languagemap->t('preferences.archiving.text'); ?>
                        <div style="margin-top: 24px;">
                            <div style="margin-bottom: 9px;">
                                <div style="width: 49%; text-align: right; float: left; padding-top: 3px;">
                                    <?php echo $this->languagemap->t('preferences.archiving.program_year'); ?>
                                </div>
                                <div style="width: 49%; float: right;">
                                    ...
                                    <label for="ap_py_radio_inactive" id="ap_py_radio_inactive_label">
                                        <?php echo $this->languagemap->t('general.terms.inactive'); ?>
                                    </label>
                                    <br/>
                                    ...
                                    <label for="ap_py_radio_active" id="ap_py_radio_active_label"
                                        ...
                                        <?php echo $this->languagemap->t('general.terms.active'); ?>
                                    </label>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div style="width: 49%; text-align: right; float: left; padding-top: 3px;">
                                <?php echo $this->languagemap->t('preferences.archiving.course'); ?>
                            </div>
                            <div style="width: 49%; float: right;">
...
?>
    ...
    <div class="tabdialog" id="report_results_dialog">
        <div class="hd" id="report_results_dialog_title">
            <?php echo $this->languagemap->t('dashboard.report.result.dialog_title'); ?>
        </div>
        <div class="bd">
                ...
                <form>
                    <div style="padding: 9px; position: relative;">
                        ...
                        <select id='report_noun_1'>
                            <option value="course"><?php echo $this->languagemap->t('general.terms.courses'); ?></option>
                            <option value="session"><?php echo $this->languagemap->t('general.terms.sessions'); ?></option>
                            <option value="program"><?php echo $this->languagemap->t('general.terms.programs'); ?></option>
                            <option value="program year"><?php echo $this->languagemap->t('general.terms.program_years'); ?></option>
                            <option value="instructor"><?php echo $this->languagemap->t('general.terms.instructors'); ?></option>
                            <option value="instructor group"><?php echo $this->languagemap->t('general.phrases.instructor_groups'); ?></option>
                            <option value="learning material"><?php echo $this->languagemap->t('general.phrases.learning_materials'); ?></option>
                            <option value="competency"><?php echo $this->languagemap->t('general.terms.competencies'); ?></option>
                            <option value="topic"><?php echo $this->languagemap->t('general.terms.topics'); ?></option>
                            <option value="mesh term"><?php echo $this->languagemap->t('general.phrases.mesh_terms'); ?></option>
                        </select>
                    ...
                    <div style="padding: 9px;">
                        <div style="margin-bottom: 20px; margin-right: 6px; position: relative; padding: 24px 0px 0px;">
                            <div style="padding: 12px 6px; border: 1px solid #AAAAAA; height: 266px;">
                                <?php echo $this->languagemap->t('learning_material.search.title'); ?>
    ...
    <div class="tabdialog" id="rollover_permissions_dialog">
        ...
        <div class="bd" style="position: relative;">
            <div class="dialog_wrap" id="rp_dialog_wrap">
                <form action="#">
                    <p>
                    <?php echo $this->languagemap->t('preferences.rollover.text'); ?>
                    </p>
