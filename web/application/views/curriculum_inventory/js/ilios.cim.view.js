                ...
                method: function (value) {
                    ...
                    if (value) {
                        ...
                        if (value.get('deleted')) {
                            ...
                            // course start date
                            str += ilios_i18nVendor.getI18NString('general.phrases.start_date') + ": " + value.get('startDate') + ", "
                            // course end date
                            str += ilios_i18nVendor.getI18NString('general.phrases.end_date') + ": " + value.get('endDate')
