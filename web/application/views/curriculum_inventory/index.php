...
<head>
    ...
    <title><?php echo $this->languagemap->t('curriculum_inventory.title_bar'); ?></title>
...
<div id="wrapper">
    ...
    <div id="main" role="main">
        ...
        <div id="content" class="clearfix">
            <h2 class="page-header"><?php echo $this->languagemap->t('curriculum_inventory.page_header'); ?></h2>
            <div class="master_button_container clearfix">
                <ul class="buttons left">
                    <li>
                        <a class="small radius button" href="" id="pick_reports_btn">
                            <?php echo $this->languagemap->t('curriculum_inventory.select_report'); ?>
                        </a>
                    </li>
                    <li>
                        <a class="small secondary radius button" href="" id="create_report_btn">
                            <?php echo $this->languagemap->t('general.phrases.create_report'); ?>
                         </a>
                    </li>
                </ul>
            </div>
