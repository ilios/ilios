...
class Ilios_CurriculumInventory_Exporter
{
    ...
    public function getCurriculumInventory ($reportId)
    {
        ...
        $includes['program_objective_ids'] = array_unique(array_merge($includes['program_objective_ids'], $rel['program_objective_ids']));
        ...
        $includes['course_objective_ids'] = array_unique(array_merge($includes['course_objective_ids'], $rel['course_objective_ids']));
