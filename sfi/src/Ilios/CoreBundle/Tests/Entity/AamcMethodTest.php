...
class AamcMethodTest extends EntityBase
{
    ...
    /**
     * @covers Ilios\CoreBundle\Entity\AamcMethod::setMethodId
     */
    public function testSetMethodId()
    {
        $this->basicSetTest('methodId', 'integer');
    }

    /**
     * @covers Ilios\CoreBundle\Entity\AamcMethod::getMethodId
     */
    public function testGetMethodId()
    {
        $this->basicGetTest('methodId', 'integer');
    }
    ...
    {
        $this->entityCollectionGetTest('sessionType', 'SessionType');
    }
}
