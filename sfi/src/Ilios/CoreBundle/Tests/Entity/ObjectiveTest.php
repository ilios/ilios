...
class ObjectiveTest extends EntityBase
{
    ...
    /**
     * @covers Ilios\CoreBundle\Entity\Objective::getObjectiveId
     */
    ...
    {
        $this->entityGetTest('competency', 'Competency');
    }

    /**
     * @covers Ilios\CoreBundle\Entity\Objective::getCompetencyId
     */
    ...
    {
        $this->entityCollectionGetTest('children', 'Objective', 'getChildren', false);
    }
    ...
    {
        $this->entityCollectionGetTest('parent', 'Objective');
    }
}
