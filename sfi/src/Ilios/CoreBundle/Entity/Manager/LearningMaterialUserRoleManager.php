...
use Ilios\CoreBundle\Model\Manager\LearningMaterialUserRoleManager as BaseLearningMaterialUserRoleManager;
use Ilios\CoreBundle\Model\LearningMaterialUserRoleInterface;

class LearningMaterialUserRoleManager extends BaseLearningMaterialUserRoleManager
{
    /**
     * @var EntityManager
     */
