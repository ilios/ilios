...
Would you like to help with Ilios development without having to do any extra work?  How about sending us your error logs in real-time so we can review them and preemptively fix them in the next release before they have the chance to become something larger?!
