...
class Version20170428054237 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE session_type SET calendar_color='ff0' WHERE session_type_css_class='opt-review-session'");
        ...
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='preceptorship'");
        ...
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='outpatient-clinic'");
        ...
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='independent-learning'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='reflection'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='self-directed-learning'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='concept-mapping'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='conference'");
        ...
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='simulation'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='case-based-instruction'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='demonstration'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='games'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='journal-club'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='mentorship'");
        ...
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='peer-teaching'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='research'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='role-play-drama'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='performance'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='tutorial'");
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='service-learning-activity'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='clinical-performance'");
        $this->addSql("UPDATE session_type SET calendar_color='00cc65' WHERE session_type_css_class='panel-presentation'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='learner-project-presentation'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='movie'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='social-event'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='deadline'");
        $this->addSql("UPDATE session_type SET calendar_color='fff' WHERE session_type_css_class='ceremony'");
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='ambulatory-clinical-experience'");
        $this->addSql("UPDATE session_type SET calendar_color='ddd' WHERE session_type_css_class='inpatient-clinical-experience'");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='holiday' WHERE calendar_color='fff'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='opt-review-session' WHERE calendar_color='ff0'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='preceptorship' WHERE calendar_color='ddd'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='outpatient-clinic' WHERE calendar_color='ddd'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='independent-learning' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='reflection' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='self-directed-learning' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='concept-mapping' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='conference' WHERE calendar_color='fff'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='simulation' WHERE calendar_color='ddd'");
        $this->addSql("UPDATE session_types SET session_type_css_color='case-based-instruction' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='demonstration' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='games' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='journal-club' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='mentorship' WHERE calendar_color='fff'");
        ...
        $this->addSql("UPDATE session_types SET session_type_css_color='peer-teaching' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='research' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='role-play-drama' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='performance' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='tutorial' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='service-learning-activity' WHERE calendar_color='ddd'");
        $this->addSql("UPDATE session_types SET session_type_css_color='clinical-performance' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='panel-presentation' WHERE calendar_color='00cc65'");
        $this->addSql("UPDATE session_types SET session_type_css_color='learner-project-presentation' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='movie' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='social-event' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='deadline' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='ceremony' WHERE calendar_color='fff'");
        $this->addSql("UPDATE session_types SET session_type_css_color='ambulatory-clinical-experience' WHERE calendar_color='ddd'");
        $this->addSql("UPDATE session_types SET session_type_css_color='inpatient-clinical-experience' WHERE calendar_color='ddd'");
        $this->addSql("UPDATE session_types SET session_type_css_color='ward-rounds' WHERE calendar_color='ddd'");
