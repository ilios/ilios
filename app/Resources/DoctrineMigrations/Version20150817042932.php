 ...
 */
class Version20150817042932 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE competency DROP FOREIGN KEY fkey_competency_owning_school_id');
        ...
        $this->addSql('ALTER TABLE session_type DROP FOREIGN KEY session_type_ibfk_1');
        ...
        $this->addSql('ALTER TABLE program DROP FOREIGN KEY fkey_program_owning_school_id');
        ...
        $this->addSql('ALTER TABLE course DROP FOREIGN KEY fkey_course_owning_school_id');
        ...
        $this->addSql('ALTER TABLE discipline DROP FOREIGN KEY fkey_discipline_owning_school_id');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE competency ADD CONSTRAINT fkey_competency_owning_school_id FOREIGN KEY (owning_school_id) REFERENCES school (school_id)');
        ...
        $this->addSql('ALTER TABLE course ADD CONSTRAINT fkey_course_owning_school_id FOREIGN KEY (owning_school_id) REFERENCES school (school_id)');
        ...
        $this->addSql('ALTER TABLE discipline ADD CONSTRAINT fkey_discipline_owning_school_id FOREIGN KEY (owning_school_id) REFERENCES school (school_id)');
        ...
        $this->addSql('ALTER TABLE program ADD CONSTRAINT fkey_program_owning_school_id FOREIGN KEY (owning_school_id) REFERENCES school (school_id)');
