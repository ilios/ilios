...
class Version20160125235702 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE term (term_id INT AUTO_INCREMENT NOT NULL, parent_term_id INT DEFAULT NULL, vocabulary_id INT NOT NULL, description LONGTEXT DEFAULT NULL, title VARCHAR(200) DEFAULT NULL, INDEX IDX_A50FE78D7C6441BA (parent_term_id), INDEX IDX_A50FE78DAD0E05F6 (vocabulary_id), UNIQUE INDEX unique_term_title (vocabulary_id, title), PRIMARY KEY(term_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vocabulary (vocabulary_id INT AUTO_INCREMENT NOT NULL, school_id INT NOT NULL, title VARCHAR(200) DEFAULT NULL, hierarchical TINYINT(1) NOT NULL, INDEX IDX_9099C97BC32A47EE (school_id), UNIQUE INDEX unique_vocabulary_title (school_id, title), PRIMARY KEY(vocabulary_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
