...
CREATE INDEX `fkey_curriculum_inventory_export_user_id` ON `curriculum_inventory_report` (created_by);
CREATE INDEX `IDX_6E31899E3EB8070A` ON `curriculum_inventory_report` (program_id);
CREATE INDEX `fkey_curriculum_inventory_sequence_block_session_session_id` ON `curriculum_inventory_sequence_block` (session_id);
