...
ALTER TABLE alert_recipient ADD KEY IDX_D97AE69D93035F72 (alert_id);
ALTER TABLE competency_x_aamc_pcrs ADD KEY IDX_1683F4A7FB9F58C (competency_id);
...
ALTER TABLE curriculum_inventory_report ADD KEY fkey_curriculum_inventory_export_user_id (created_by) ;
ALTER TABLE curriculum_inventory_report ADD KEY IDX_6E31899E3EB8070A (program_id);
ALTER TABLE curriculum_inventory_sequence_block ADD KEY fkey_curriculum_inventory_sequence_block_session_session_id (session_id);
ALTER TABLE curriculum_inventory_sequence_block_session ADD KEY IDX_CF8E4F1261D1D223 (sequence_block_id);
ALTER TABLE group_x_instructor ADD KEY IDX_8CE57915FE54D947 (group_id);
ALTER TABLE group_x_instructor_group ADD KEY IDX_49AFEA21FE54D947 (group_id);
ALTER TABLE group_x_user ADD KEY IDX_93A1A790FE54D947 (group_id);
ALTER TABLE ilm_session_facet_x_group ADD KEY IDX_B43B41DC504270C1 (ilm_session_facet_id);
ALTER TABLE ilm_session_facet_x_instructor_group ADD KEY IDX_8171A2F3504270C1 (ilm_session_facet_id);
ALTER TABLE offering_x_instructor ADD KEY IDX_171DC5498EDF74F0 (offering_id);
ALTER TABLE program_year_director ADD KEY IDX_9212A50DCB2B0673 (program_year_id);
ALTER TABLE program_year_x_discipline ADD KEY IDX_ED2A7194CB2B0673 (program_year_id);
ALTER TABLE program_year_x_objective ADD KEY IDX_FF29E643CB2B0673 (program_year_id);
ALTER TABLE `session` ADD KEY session_ibfk_3 (ilm_session_facet_id);
ALTER TABLE session_x_discipline ADD KEY IDX_EA7C234F613FECDF (session_id);
ALTER TABLE session_x_objective ADD KEY IDX_C4BF2447613FECDF (session_id);
ALTER TABLE session_type ADD KEY owning_school_id (owning_school_id);
ALTER TABLE user_x_cohort ADD KEY IDX_4DFD48DAA76ED395 (user_id);
