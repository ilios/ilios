...
CALL drop_index_if_exists('report_po_value', 'fkey_report_po_value_report_id');
...
ALTER TABLE `group_x_group` CHANGE `group_a_id` `group_a_id` INT NOT NULL;
ALTER TABLE `group_x_group` CHANGE `group_b_id` `group_b_id` INT SIGNED NOT NULL;
...
ALTER TABLE `learning_material` CHANGE `copyright_ownership` `copyright_ownership` TINYINT DEFAULT NULL;
...
ALTER TABLE `mesh_user_selection` CHANGE `search_phrase` `search_phrase` VARCHAR(127) DEFAULT NULL;
...
ALTER TABLE `publish_event` CHANGE `table_row_id` `table_row_id` INT NOT NULL;
...
ALTER TABLE `report_po_value` CHANGE `report_id` `report_id` INT NOT NULL;
...
ALTER TABLE `session_description` CHANGE `description` `description` TEXT DEFAULT NULL;
...
ALTER TABLE `report_po_value` ADD PRIMARY KEY (report_id);
...
ALTER TABLE `group_x_group` ADD PRIMARY KEY (group_a_id, group_b_id);
...
ALTER TABLE `alert_change` ADD CONSTRAINT fkey_alert_change_alert_type_id FOREIGN KEY (`alert_change_type_id`) REFERENCES `alert_change_type` (`alert_change_type_id`);
...
ALTER TABLE `api_key` ADD CONSTRAINT fk_api_key_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `audit_atom` ADD CONSTRAINT fkey_audit_atom_created_by FOREIGN KEY (`created_by`) REFERENCES `user` (`user_id`);
ALTER TABLE `authentication` ADD CONSTRAINT fkey_authentication_user FOREIGN KEY (`person_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `cohort` ADD CONSTRAINT fkey_cohort_program_year_id FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`);
ALTER TABLE `competency` ADD CONSTRAINT competency_ibfk_1 FOREIGN KEY (`parent_competency_id`) REFERENCES `competency` (`competency_id`);
ALTER TABLE `competency` ADD CONSTRAINT fkey_competency_owning_school_id FOREIGN KEY (`owning_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `competency_x_aamc_pcrs` ADD CONSTRAINT competency_id_fkey FOREIGN KEY (`competency_id`) REFERENCES `competency` (`competency_id`);
ALTER TABLE `competency_x_aamc_pcrs` ADD CONSTRAINT aamc_pcrs_id_fkey FOREIGN KEY (`pcrs_id`) REFERENCES `aamc_pcrs` (`pcrs_id`);
ALTER TABLE `course` ADD CONSTRAINT fkey_course_owning_school_id FOREIGN KEY (`owning_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `course` ADD CONSTRAINT fkey_course_publish_event_id FOREIGN KEY (`publish_event_id`) REFERENCES `publish_event` (`publish_event_id`);
ALTER TABLE `course_director` ADD CONSTRAINT fkey_course_director_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`);
ALTER TABLE `course_director` ADD CONSTRAINT fkey_course_director_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `course_learning_material` ADD CONSTRAINT course_learning_material_ibfk_2 FOREIGN KEY (`learning_material_id`) REFERENCES `learning_material` (`learning_material_id`);
...
ALTER TABLE `course_learning_material_x_mesh` ADD CONSTRAINT course_learning_material_x_mesh_ibfk_1 FOREIGN KEY (`course_learning_material_id`) REFERENCES `course_learning_material` (`course_learning_material_id`);
ALTER TABLE `course_x_cohort` ADD CONSTRAINT fkey_course_x_cohort_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_cohort` ADD CONSTRAINT fkey_course_x_cohort_cohort_id FOREIGN KEY (`cohort_id`) REFERENCES `cohort` (`cohort_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_discipline` ADD CONSTRAINT fkey_course_x_discipline_discipline_id FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_discipline` ADD CONSTRAINT fkey_course_x_discipline_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_mesh` ADD CONSTRAINT fkey_course_x_mesh_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_mesh` ADD CONSTRAINT fkey_course_x_mesh_descriptor FOREIGN KEY (`mesh_descriptor_uid`) REFERENCES `mesh_descriptor` (`mesh_descriptor_uid`) ON DELETE CASCADE;
ALTER TABLE `course_x_objective` ADD CONSTRAINT fkey_course_x_objective_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE;
ALTER TABLE `course_x_objective` ADD CONSTRAINT fkey_course_x_objective_objective_id FOREIGN KEY (`objective_id`) REFERENCES `objective` (`objective_id`) ON DELETE CASCADE;
ALTER TABLE `curriculum_inventory_academic_level` ADD CONSTRAINT fkey_curriculum_inventory_academic_level_report_id FOREIGN KEY (`report_id`) REFERENCES `curriculum_inventory_report` (`report_id`);
ALTER TABLE `curriculum_inventory_export` ADD CONSTRAINT fkey_curriculum_inventory_export_user_id FOREIGN KEY (`created_by`) REFERENCES `user` (`user_id`);
ALTER TABLE `curriculum_inventory_export` ADD CONSTRAINT fkey_curriculum_inventory_export_report_id FOREIGN KEY (`report_id`) REFERENCES `curriculum_inventory_report` (`report_id`);
ALTER TABLE `curriculum_inventory_institution` ADD CONSTRAINT fkey_curriculum_inventory_institution_school_id FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `curriculum_inventory_report` ADD CONSTRAINT fkey_curriculum_inventory_report_program_id FOREIGN KEY (`program_id`) REFERENCES `program` (`program_id`);
ALTER TABLE `curriculum_inventory_sequence` ADD CONSTRAINT fkey_curriculum_inventory_sequence_report_id FOREIGN KEY (`report_id`) REFERENCES `curriculum_inventory_report` (`report_id`);
ALTER TABLE `curriculum_inventory_sequence_block` ADD CONSTRAINT fkey_curriculum_inventory_sequence_block_parent_id FOREIGN KEY (`parent_sequence_block_id`) REFERENCES `curriculum_inventory_sequence_block` (`sequence_block_id`);
ALTER TABLE `curriculum_inventory_sequence_block` ADD CONSTRAINT fkey_curriculum_inventory_sequence_block_course_id FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`);
ALTER TABLE `curriculum_inventory_sequence_block` ADD CONSTRAINT fkey_curriculum_inventory_sequence_block_report_id FOREIGN KEY (`report_id`) REFERENCES `curriculum_inventory_report` (`report_id`);
ALTER TABLE `curriculum_inventory_sequence_block` ADD CONSTRAINT fkey_curriculum_inventory_sequence_block_academic_level_id FOREIGN KEY (`academic_level_id`) REFERENCES `curriculum_inventory_academic_level` (`academic_level_id`);
ALTER TABLE `curriculum_inventory_sequence_block_session` ADD CONSTRAINT fkey_ci_sequence_block_session_sequence_block_id FOREIGN KEY (`sequence_block_id`) REFERENCES `curriculum_inventory_sequence_block` (`sequence_block_id`);
ALTER TABLE `curriculum_inventory_sequence_block_session` ADD CONSTRAINT fkey_curriculum_inventory_sequence_block_session_session_id FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`);
ALTER TABLE `department` ADD CONSTRAINT fkey_department_school_id FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `discipline` ADD CONSTRAINT fkey_discipline_owning_school_id FOREIGN KEY (`owning_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `group` ADD CONSTRAINT fkey_group_parent_group_id FOREIGN KEY (`parent_group_id`) REFERENCES `group` (`group_id`);
ALTER TABLE `group` ADD CONSTRAINT fkey_group_cohort_id FOREIGN KEY (`cohort_id`) REFERENCES `cohort` (`cohort_id`) ON DELETE CASCADE;
ALTER TABLE `group_x_instructor` ADD CONSTRAINT fkey_group_x_instructor_group_id FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`) ON DELETE CASCADE;
ALTER TABLE `group_x_instructor` ADD CONSTRAINT fkey_group_x_instructor_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `group_x_instructor_group` ADD CONSTRAINT fkey_group_x_instructor_group_instructor_group_id FOREIGN KEY (`instructor_group_id`) REFERENCES `instructor_group` (`instructor_group_id`) ON DELETE CASCADE;
ALTER TABLE `group_x_instructor_group` ADD CONSTRAINT fkey_group_x_instructor_group_group_id FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`) ON DELETE CASCADE;
ALTER TABLE `group_x_user` ADD CONSTRAINT group_x_user_ibfk_1 FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`);
ALTER TABLE `group_x_user` ADD CONSTRAINT group_x_user_ibfk_2 FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `ilm_session_facet_x_group` ADD CONSTRAINT fkey_ilm_session_facet_x_group_ilm_session_facet_id FOREIGN KEY (`ilm_session_facet_id`) REFERENCES `ilm_session_facet` (`ilm_session_facet_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_group` ADD CONSTRAINT fkey_ilm_session_facet_x_group_group_id FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_instructor` ADD CONSTRAINT fkey_ilm_session_facet_x_instructor_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_instructor` ADD CONSTRAINT fkey_ilm_session_facet_x_instructor_ilm_session_facet_id FOREIGN KEY (`ilm_session_facet_id`) REFERENCES `ilm_session_facet` (`ilm_session_facet_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_instructor_group` ADD CONSTRAINT fkey_ilm_session_facet_x_instructor_group_instructor_group_id FOREIGN KEY (`instructor_group_id`) REFERENCES `instructor_group` (`instructor_group_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_instructor_group` ADD CONSTRAINT fkey_ilm_session_facet_x_instructor_group_ilm_session_facet_id FOREIGN KEY (`ilm_session_facet_id`) REFERENCES `ilm_session_facet` (`ilm_session_facet_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_learner` ADD CONSTRAINT fkey_ilm_session_facet_x_learner_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `ilm_session_facet_x_learner` ADD CONSTRAINT fkey_ilm_session_facet_x_learner_ilm_session_facet_id FOREIGN KEY (`ilm_session_facet_id`) REFERENCES `ilm_session_facet` (`ilm_session_facet_id`) ON DELETE CASCADE;
ALTER TABLE `ingestion_exception` ADD CONSTRAINT fkey_ingestion_exception_user FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
...
ALTER TABLE `instructor_group_x_user` ADD CONSTRAINT instructor_group_x_user_ibfk_1 FOREIGN KEY (`instructor_group_id`) REFERENCES `instructor_group` (`instructor_group_id`);
ALTER TABLE `instructor_group_x_user` ADD CONSTRAINT instructor_group_x_user_ibfk_2 FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `learning_material` ADD CONSTRAINT fkey_learning_material_learning_material_status_id FOREIGN KEY (`learning_material_status_id`) REFERENCES `learning_material_status` (`learning_material_status_id`);
ALTER TABLE `learning_material` ADD CONSTRAINT fkey_learning_material_owning_user_id FOREIGN KEY (`owning_user_id`) REFERENCES `user` (`user_id`);
...
ALTER TABLE `mesh_concept_x_term` ADD CONSTRAINT FK_100AC50FE34D9FF5 FOREIGN KEY (`mesh_concept_uid`) REFERENCES `mesh_concept` (`mesh_concept_uid`);
ALTER TABLE `mesh_concept_x_term` ADD CONSTRAINT FK_100AC50F17293A95 FOREIGN KEY (`mesh_term_uid`) REFERENCES `mesh_term` (`mesh_term_uid`);
...
ALTER TABLE `mesh_user_selection` ADD CONSTRAINT fkey_mesh_user_select_descriptor FOREIGN KEY (`mesh_descriptor_uid`) REFERENCES `mesh_descriptor` (`mesh_descriptor_uid`) ON DELETE CASCADE;
ALTER TABLE `objective` ADD CONSTRAINT fkey_objective_competency FOREIGN KEY (`competency_id`) REFERENCES `competency` (`competency_id`);
ALTER TABLE `objective_x_mesh` ADD CONSTRAINT fkey_objective_x_mesh_objective_id FOREIGN KEY (`objective_id`) REFERENCES `objective` (`objective_id`);
...
ALTER TABLE `objective_x_objective` ADD CONSTRAINT fkey_objective_x_objective_objective_id FOREIGN KEY (`objective_id`) REFERENCES `objective` (`objective_id`);
ALTER TABLE `objective_x_objective` ADD CONSTRAINT fkey_objective_x_objective_parent_objective_id FOREIGN KEY (`parent_objective_id`) REFERENCES `objective` (`objective_id`);
ALTER TABLE `offering` ADD CONSTRAINT offering_ibfk_1 FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`);
ALTER TABLE `offering` ADD CONSTRAINT fkey_offering_publish_event_id FOREIGN KEY (`publish_event_id`) REFERENCES `publish_event` (`publish_event_id`);
ALTER TABLE `offering_x_group` ADD CONSTRAINT fkey_offering_x_group_group_id FOREIGN KEY (`group_id`) REFERENCES `group` (`group_id`);
ALTER TABLE `offering_x_group` ADD CONSTRAINT fkey_offering_x_group_offering_id FOREIGN KEY (`offering_id`) REFERENCES `offering` (`offering_id`);
ALTER TABLE `offering_x_instructor` ADD CONSTRAINT fkey_offering_x_instructor_offering_id FOREIGN KEY (`offering_id`) REFERENCES `offering` (`offering_id`);
ALTER TABLE `offering_x_instructor` ADD CONSTRAINT fkey_offering_x_instructor_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `offering_x_instructor_group` ADD CONSTRAINT fkey_offering_x_instructor_group_instructor_group_id FOREIGN KEY (`instructor_group_id`) REFERENCES `instructor_group` (`instructor_group_id`);
ALTER TABLE `offering_x_instructor_group` ADD CONSTRAINT fkey_offering_x_instructor_group_offering_id FOREIGN KEY (`offering_id`) REFERENCES `offering` (`offering_id`);
ALTER TABLE `offering_x_learner` ADD CONSTRAINT fkey_offering_x_learner_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `offering_x_learner` ADD CONSTRAINT fkey_offering_x_learner_offering_id FOREIGN KEY (`offering_id`) REFERENCES `offering` (`offering_id`);
...
ALTER TABLE `program` ADD CONSTRAINT fkey_program_publish_event_id FOREIGN KEY (`publish_event_id`) REFERENCES `publish_event` (`publish_event_id`);
ALTER TABLE `program` ADD CONSTRAINT fkey_program_owning_school_id FOREIGN KEY (`owning_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `program_year` ADD CONSTRAINT fkey_program_year_publish_event_id FOREIGN KEY (`publish_event_id`) REFERENCES `publish_event` (`publish_event_id`);
ALTER TABLE `program_year` ADD CONSTRAINT fkey_program_year_program_id FOREIGN KEY (`program_id`) REFERENCES `program` (`program_id`);
ALTER TABLE `program_year_director` ADD CONSTRAINT fkey_program_year_director_user FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `program_year_director` ADD CONSTRAINT fkey_program_year_director_program_year FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`);
ALTER TABLE `program_year_steward` ADD CONSTRAINT fkey_program_year_steward_program_year FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_steward` ADD CONSTRAINT fkey_program_year_steward_department FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_steward` ADD CONSTRAINT fkey_program_year_steward_school FOREIGN KEY (`school_id`) REFERENCES `school` (`school_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_competency` ADD CONSTRAINT fkey_program_year_x_competency_prg_yr_id FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_competency` ADD CONSTRAINT fkey_program_year_x_competency_competency_id FOREIGN KEY (`competency_id`) REFERENCES `competency` (`competency_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_discipline` ADD CONSTRAINT fkey_program_year_x_discipline_prg_yr_id FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_discipline` ADD CONSTRAINT fkey_program_year_x_discipline_discipline_id FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_objective` ADD CONSTRAINT fkey_program_year_x_objective_prg_yr_id FOREIGN KEY (`program_year_id`) REFERENCES `program_year` (`program_year_id`) ON DELETE CASCADE;
ALTER TABLE `program_year_x_objective` ADD CONSTRAINT fkey_program_year_x_objective_obj_id FOREIGN KEY (`objective_id`) REFERENCES `objective` (`objective_id`) ON DELETE CASCADE;
ALTER TABLE `publish_event` ADD CONSTRAINT fkey_publish_event_administrator_id FOREIGN KEY (`administrator_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `recurring_event` ADD CONSTRAINT fkey_recurring_event_previous_recurring_event_id FOREIGN KEY (`previous_recurring_event_id`) REFERENCES `recurring_event` (`recurring_event_id`);
ALTER TABLE `recurring_event` ADD CONSTRAINT fkey_recurring_event_next_recurring_event_id FOREIGN KEY (`next_recurring_event_id`) REFERENCES `recurring_event` (`recurring_event_id`);
ALTER TABLE `report` ADD CONSTRAINT fkey_report_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `report_po_value` ADD CONSTRAINT fkey_report_po_value_report_id FOREIGN KEY (`report_id`) REFERENCES `report` (`report_id`) ON DELETE CASCADE;
ALTER TABLE `session` ADD CONSTRAINT fkey_session_publish_event_id FOREIGN KEY (`publish_event_id`) REFERENCES `publish_event` (`publish_event_id`);
ALTER TABLE `session` ADD CONSTRAINT session_ibfk_2 FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`);
ALTER TABLE `session` ADD CONSTRAINT session_ibfk_3 FOREIGN KEY (`ilm_session_facet_id`) REFERENCES `ilm_session_facet` (`ilm_session_facet_id`);
ALTER TABLE `session` ADD CONSTRAINT session_ibfk_1 FOREIGN KEY (`session_type_id`) REFERENCES `session_type` (`session_type_id`);
ALTER TABLE `session_description` ADD CONSTRAINT session_description_ibfk_1 FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`);
ALTER TABLE `session_learning_material` ADD CONSTRAINT session_learning_material_ibfk_1 FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`);
ALTER TABLE `session_learning_material` ADD CONSTRAINT session_learning_material_ibfk_2 FOREIGN KEY (`learning_material_id`) REFERENCES `learning_material` (`learning_material_id`);
ALTER TABLE `session_learning_material_x_mesh` ADD CONSTRAINT session_learning_material_x_mesh_fk_mesh FOREIGN KEY (`mesh_descriptor_uid`) REFERENCES `mesh_descriptor` (`mesh_descriptor_uid`) ON DELETE CASCADE;
ALTER TABLE `session_learning_material_x_mesh` ADD CONSTRAINT session_learning_material_x_mesh_fk_session FOREIGN KEY (`session_learning_material_id`) REFERENCES `session_learning_material` (`session_learning_material_id`) ON DELETE CASCADE;
ALTER TABLE `session_type` ADD CONSTRAINT session_type_ibfk_1 FOREIGN KEY (`owning_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `session_type` ADD CONSTRAINT assessment_option_fkey FOREIGN KEY (`assessment_option_id`) REFERENCES `assessment_option` (`assessment_option_id`);
ALTER TABLE `session_type_x_aamc_method` ADD CONSTRAINT session_type_id_fkey FOREIGN KEY (`session_type_id`) REFERENCES `session_type` (`session_type_id`);
ALTER TABLE `session_type_x_aamc_method` ADD CONSTRAINT aamc_method_id_fkey FOREIGN KEY (`method_id`) REFERENCES `aamc_method` (`method_id`);
ALTER TABLE `session_x_discipline` ADD CONSTRAINT fkey_session_x_discipline_discipline_id FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`) ON DELETE CASCADE;
ALTER TABLE `session_x_discipline` ADD CONSTRAINT fkey_session_x_discipline_session_id FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`) ON DELETE CASCADE;
ALTER TABLE `session_x_mesh` ADD CONSTRAINT fkey_session_x_mesh_mesh_d FOREIGN KEY (`mesh_descriptor_uid`) REFERENCES `mesh_descriptor` (`mesh_descriptor_uid`) ON DELETE CASCADE;
ALTER TABLE `session_x_mesh` ADD CONSTRAINT fkey_session_x_mesh_session_id FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`) ON DELETE CASCADE;
ALTER TABLE `session_x_objective` ADD CONSTRAINT fkey_session_x_objective_session_id FOREIGN KEY (`session_id`) REFERENCES `session` (`session_id`) ON DELETE CASCADE;
ALTER TABLE `session_x_objective` ADD CONSTRAINT fkey_session_x_objective_objective_id FOREIGN KEY (`objective_id`) REFERENCES `objective` (`objective_id`) ON DELETE CASCADE;
ALTER TABLE `user` ADD CONSTRAINT fkey_user_primary_school FOREIGN KEY (`primary_school_id`) REFERENCES `school` (`school_id`);
ALTER TABLE `user_sync_exception` ADD CONSTRAINT user_id_fkey FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `user_made_reminder` ADD CONSTRAINT fkey_user_mode_reminder_user_id FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
ALTER TABLE `user_x_cohort` ADD CONSTRAINT fkey_user_x_cohort_user FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
